...
function GeoRegion(; name="", continent="", subregion="", admin="", skip_areas=nothing, resolution=nothing)
    ...
    d = CountriesBorders.extract_countries(; resolution, skip_areas, kwargs...)
